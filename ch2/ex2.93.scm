...
(define r2 (make-rational n2 d2))

;; 1 ]=> (add r1 r2)

;; ;Value 22: (rational (polynomial x (4 1) (3 1) (2 1) (1 -2) (0 -1)) (polynomial x (5 1) (3 -1) (2 -1) (0 1)))

;; numer: x^4 + x^3 + x^2 - 2x - 1
;; denom: x^5 - x^3 - x^2 + 1
...
;; x^2 + x
(define t1 '(polynomial x (2 1) (1 1)))

;; x^3 + x^2
(define t2 '(polynomial x (3 2) (2 1)))
